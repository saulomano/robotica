...
var ResourceSchema = new Schema({
		...
		programa: [{ type: Schema.Types.ObjectId, ref: 'File' }],
		imagen: [{ type: Schema.Types.ObjectId, ref: 'File' }],
		pdf: [{ type: Schema.Types.ObjectId, ref: 'File' }],
		presentacion: [{ type: Schema.Types.ObjectId, ref: 'File' }],
